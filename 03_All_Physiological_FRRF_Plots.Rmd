...
``` {r  plot Growthrate.Percent..u.umax., eval=TRUE, echo=FALSE}
...
# p2 - cell.size..um
``` {r  plot cell.size..um, eval=TRUE, echo=FALSE}
...
``` {r  plot cell.volume.fl.cell, eval=TRUE, echo=FALSE}
...
``` {r  plot GrossPchla.mol.O2.mol.Chla..h., eval=TRUE, echo=FALSE}
...
``` {r  plot FeDFB.zmol.um.2.h., eval=TRUE, echo=FALSE}
...
``` {r  plot Chla.per.cell.pg.cell, eval=TRUE, echo=FALSE }
...
``` {r  plot Chla.per.cell.vol.fg.fL, eval=TRUE, echo=FALSE}
...
# p8 - AOXactivity
``` {r  plot AOXactivity, eval=TRUE, echo=FALSE}
...
# p9 - FvFm.old
``` {r  plot FvFm.old, eval=TRUE, echo=FALSE}
...
# p10 - Sig.old
``` {r  plot Sig.old, eval=TRUE, echo=FALSE}
...
# p11 - PQ_Siz.old 
``` {r  plot PQ_Siz.old ,eval=TRUE, echo=FALSE}
...
# p13 - ETR.alpha.JP
``` {r  plot ETR.alpha.JP, eval=TRUE, echo=FALSE}
...
```{r plot_file_ETR.alpha.JP, eval=FALSE, echo=FALSE}
png('plots/ALL_Phys_Barplots/lowCu_ETR.alpha.JP.png', width=680, height = 480, units ="px", pointsize = 12) #directly puts plot into file without showing it in plot window first!
...
# p14 - ETR.pmax.JP
``` {r  plot ETR.pmax.JP, eval=TRUE, echo=FALSE}
...
```{r plot_file_ETR.pmax.JP, eval=FALSE, echo=FALSE}
png('plots/ALL_Phys_Barplots/lowCu_ETR.pmax.JP.png', width=680, height = 480, units ="px", pointsize = 12) #directly puts plot into file without showing it in plot window first!
...
# p15 - ETR.ek.JP
``` {r  plot ETR.ek.JP, eval=TRUE, echo=FALSE}
...
```{r plot_file_ETR.ek.JP, eval=FALSE, echo=FALSE}
png('plots/ALL_Phys_Barplots/lowCu_ETR.ek.JP.png', width=680, height = 480, units ="px", pointsize = 12) #directly puts plot into file without showing it in plot window first!
...
# p16 - ETR_155_calc
``` {r  plot ETR_155_calc, eval=TRUE, echo=FALSE}
...
```{r plot_file_ETR_155_calc, eval=FALSE, echo=FALSE}
png('plots/ALL_Phys_Barplots/lowCu_ETR_155_calc.png', width=680, height = 480, units ="px", pointsize = 12) #directly puts plot into file without showing it in plot window first!
...
# p17 - F.q.F.v
``` {r  plot F.q.F.v, eval=TRUE, echo=FALSE}
...
```{r plot_file_F.q.F.v, eval=FALSE, echo=FALSE}
png('plots/ALL_Phys_Barplots/lowCu_F.q.F.v.png', width=680, height = 480, units ="px", pointsize = 12) #directly puts plot into file without showing it in plot window first!
...
# p18 - F.q.F.m
``` {r  plot F.q.F.m, eval=TRUE, echo=FALSE}
...
```{r plot_file_F.q.F.m, eval=FALSE, echo=FALSE}
png('plots/ALL_Phys_Barplots/lowCu_F.q.F.m.png', width=680, height = 480, units ="px", pointsize = 12) #directly puts plot into file without showing it in plot window first!
...
# p19 - NPQ.nsv.
``` {r  plot NPQ.nsv., eval=TRUE, echo=FALSE}
...
```{r plot_file_NPQ.nsv., eval=FALSE, echo=FALSE}
png('plots/ALL_Phys_Barplots/lowCu_NPQ.nsv..png', width=680, height = 480, units ="px", pointsize = 12) #directly puts plot into file without showing it in plot window first!
...
``` {r  plot X14C.per.Chla.alpha, eval=TRUE, echo=FALSE}
...
```{r plot_file_X14C.per.Chla.alpha, eval=FALSE, echo=FALSE}
png('plots/ALL_Phys_Barplots/lowCu_X14C.per.Chla.alpha.png', width=680, height = 480, units ="px", pointsize = 12) #directly puts plot into file without showing it in plot window first!
...
``` {r  plot X14C.per.Chla.pmax, eval=TRUE, echo=FALSE}
...
```{r plot_file_X14C.per.Chla.pmax, eval=FALSE, echo=FALSE}
png('plots/ALL_Phys_Barplots/lowCu_X14C.per.Chla.pmax.png', width=680, height = 480, units ="px", pointsize = 12) #directly puts plot into file without showing it in plot window first!
...
``` {r  plot X14C.per.Chla.ek, eval=TRUE, echo=FALSE}
...
```{r plot_file_X14C.per.Chla.ek, eval=FALSE, echo=FALSE}
png('plots/ALL_Phys_Barplots/lowCu_X14C.per.Chla.ek.png', width=680, height = 480, units ="px", pointsize = 12) #directly puts plot into file without showing it in plot window first!
...
``` {r  plot X14C.per.Chla.at.155uE, eval=TRUE, echo=FALSE}
...
```{r plot_file_X14C.per.Chla.at.155uE, eval=FALSE, echo=FALSE}
png('plots/ALL_Phys_Barplots/lowCu_X14C.per.Chla.at.155uE.png', width=680, height = 480, units ="px", pointsize = 12) #directly puts plot into file without showing it in plot window first!
...
# p25 - cell.SA.um2
``` {r  plot cell.SA.um2, eval=T, echo=T}
...
```{r plot_file_cell.SA.um2, eval=FALSE, echo=FALSE}
png('plots/ALL_Phys_Barplots/lowCu_cell.SA.um2.png', width=680, height = 480, units ="px", pointsize = 12) #directly puts plot into file without showing it in plot window first!
...
``` {r  plot cell.SA.Vol.ratio, eval=TRUE, echo=T}
...
```{r plot_file_cell.SA.Vol.ratio, eval=FALSE, echo=FALSE}
png('plots/ALL_Phys_Barplots/lowCu_cell.SA.Vol.ratio.png', width=680, height = 480, units ="px", pointsize = 12) #directly puts plot into file without showing it in plot window first!
...
``` {r  plot Gross.mol.O2.mol.Chla.h.mod, eval=TRUE, echo=FALSE}
...
```{r plot_file_Gross.mol.O2.mol.Chla.h.mod, eval=FALSE, echo=FALSE}
png('plots/ALL_Phys_Barplots/lowCu_Gross.mol.O2.mol.Chla.h.mod.png', width=680, height = 480, units ="px", pointsize = 12) #directly puts plot into file without showing it in plot window first!
...
``` {r  plot NET.mol.O2.mol.Chla.h.mod, eval=TRUE, echo=FALSE}
...
```{r plot_file_NET.mol.O2.mol.Chla.h.mod, eval=FALSE, echo=FALSE}
png('plots/ALL_Phys_Barplots/lowCu_NET.mol.O2.mol.Chla.h.png', width=680, height = 480, units ="px", pointsize = 12) #directly puts plot into file without showing it in plot window first!
...
``` {r  plot X14C.molC.per.mol.Chla.h, eval=TRUE, echo=FALSE}
...
```{r plot_file_X14C.molC.per.mol.Chla.h, eval=FALSE, echo=FALSE}
png('plots/ALL_Phys_Barplots/lowCu_X14C.molC.per.mol.Chla.h.png', width=680, height = 480, units ="px", pointsize = 12) #directly puts plot into file without showing it in plot window first!
...
# p29 - PQ.Chla.all
``` {r  plot PQ.Chla.all, eval=TRUE, echo=FALSE}
...
```{r plot_file_PQ.Chla.all, eval=FALSE, echo=FALSE}
png('plots/ALL_Phys_Barplots/lowCu_PQ.Chla.all.png', width=680, height = 480, units ="px", pointsize = 12) #directly puts plot into file without showing it in plot window first!
...
``` {r  plot PQ.Chla.all.delete, eval=TRUE, echo=FALSE}
...
```{r plot_file_PQ.Chla.all.delete, eval=FALSE, echo=FALSE}
png('plots/ALL_Phys_Barplots/lowCu_PQ.Chla.all.delete.png', width=680, height = 480, units ="px", pointsize = 12) #directly puts plot into file without showing it in plot window first!
...
# p31 - NET.PQ.Chla
``` {r  plot NET.PQ.Chla, eval=TRUE, echo=FALSE}
...
```{r plot_file_NET.PQ.Chla, eval=FALSE, echo=FALSE}
png('plots/ALL_Phys_Barplots/lowCu_NET.PQ.Chla.png', width=680, height = 480, units ="px", pointsize = 12) #directly puts plot into file without showing it in plot window first!
...
``` {r  plot Resp.mol.O2.mol.Chla.h, eval=TRUE, echo=FALSE}
...
```{r plot_file_Resp.mol.O2.mol.Chla.h, eval=FALSE, echo=FALSE}
png('plots/ALL_Phys_Barplots/lowCu_Resp.mol.O2.mol.Chla.h.png', width=680, height = 480, units ="px", pointsize = 12) #directly puts plot into file without showing it in plot window first!
...
``` {r  plot X14C.fgC.per.cell.h.alpha, eval=TRUE, echo=FALSE}
...
```{r plot_file_X14C.fgC.per.cell.h.alpha, eval=FALSE, echo=FALSE}
png('plots/ALL_Phys_Barplots/lowCu_X14C.fgC.per.cell.h.alpha.png', width=680, height = 480, units ="px", pointsize = 12) #directly puts plot into file without showing it in plot window first!
...
``` {r  plot X14C.fgC.per.cell.h.pmax, eval=TRUE, echo=FALSE}
...
```{r plot_file_X14C.fgC.per.cell.h.pmax, eval=FALSE, echo=FALSE}
png('plots/ALL_Phys_Barplots/lowCu_X14C.fgC.per.cell.h.pmax.png', width=680, height = 480, units ="px", pointsize = 12) #directly puts plot into file without showing it in plot window first!
...
``` {r  plot X14C.fgC.per.cell.h.ek, eval=TRUE, echo=FALSE}
...
```{r plot_file_X14C.fgC.per.cell.h.ek, eval=FALSE, echo=FALSE}
png('plots/ALL_Phys_Barplots/lowCu_X14C.fgC.per.cell.h.ek.png', width=680, height = 480, units ="px", pointsize = 12) #directly puts plot into file without showing it in plot window first!
...
``` {r  plot X14C.fgC.per.cell.h.at.155E, eval=TRUE, echo=FALSE}
...
```{r plot_file_X14C.fgC.per.cell.h.at.155E, eval=FALSE, echo=FALSE}
png('plots/ALL_Phys_Barplots/lowCu_X14C.fgC.per.cell.h.at.155E.png', width=680, height = 480, units ="px", pointsize = 12) #directly puts plot into file without showing it in plot window first!
...
# p37 - ug.prot.cell
``` {r  plot ug.prot.cell, eval=TRUE, echo=FALSE }
...
```{r plot_file_pg.prot.cell, eval=FALSE, echo=FALSE}
png('plots/ALL_Phys_Barplots/lowCu_pg.prot.cell.png', width=680, height = 480, units ="px", pointsize = 12) #directly puts plot into file without showing it in plot window first!
...
# p38 - pg.prot.fl.cell
``` {r  plot pg.prot.fl.cell, eval=TRUE, echo=FALSE}
...
```{r plot_file_pg.prot.fl.cell, eval=FALSE, echo=FALSE}
png('plots/ALL_Phys_Barplots/lowCu_pg.prot.fl.cell.png', width=680, height = 480, units ="px", pointsize = 12) #directly puts plot into file without showing it in plot window first!

p + geom_bar(color = "black", position=position_dodge(), stat="identity", width = .6) +
  scale_fill_manual(values = Species_colours) +
  geom_errorbar(aes(ymin = mean.pg.prot.fl.cell - sd.err.pg.prot.fl.cell, ymax = mean.pg.prot.fl.cell + sd.err.ug.prot.fl.cell),
                  width = .15,                    # Width of the error bars
                  position = position_dodge(.6), #so the error bars are dodged to the side
                  colour = "black") +
  cleanup +
...
``` {r  plot Resp.mol.O2.mol.Chla.h_02, eval=TRUE, echo=FALSE}
p <- ggplot(mydata.mean.stderr, aes(x=Treatment, y=mean.Resp.mol.O2.mol.Chla.h, fill = Species)) + 
...
```{r plot_file_Resp.mol.O2.mol.Chla.h_02, eval=FALSE, echo=FALSE}
png('plots/ALL_Phys_Barplots/lowCu_Resp.mol.O2.mol.Chla.hpng', width=680, height = 480, units ="px", pointsize = 12) #directly puts plot into file without showing it in plot window first!
...
``` {r  plot Resp.umol.O2.cell.h, eval=TRUE, echo=FALSE}
...
```{r plot_file_Resp.umol.O2.cell.h, eval=FALSE, echo=FALSE}
png('plots/ALL_Phys_Barplots/lowCu_Resp.umol.O2.cell.hpng', width=680, height = 480, units ="px", pointsize = 12) #directly puts plot into file without showing it in plot window first!
...
# p1 - OOOOOOOO
``` {r  plot OOOOOOOO, eval=FALSE, echo=TRUE}
...
```{r data_input_growthrates_tubes, eval=T}
...
```{r mean_std_error_table_tube growthrates, eval=T}
...
``` {r  plot growthrates of tubes, eval=TRUE, echo=FALSE}
...
```{r plot_file_growthrates_Tubes, eval=FALSE, echo=FALSE}
png('plots/ALL_Phys_Barplots/TUBES_growthrates_lowCu.png', width=680, height = 480, units ="px", pointsize = 12) #directly puts plot into file without showing it in plot window first!
...
```{r print multiplot compare 14C data normalization Chla vs Cell}
...
```{r print multiplot For Paper Version01}
...
```{r print multiplot For Paper Version02}
